...
# MLflow setup: runs on localhost inside the CI runner
mlflow.set_tracking_uri("http://localhost:5000")
mlflow.set_experiment("tourism-mlops-experiment")

api = HfApi(token=os.getenv("HF_TOKEN"))

# Load the prepared train/test splits directly from the HF dataset space
Xtrain_path = "hf://datasets/BalajiVG/tourism-package-prediction/Xtrain.csv"
Xtest_path  = "hf://datasets/BalajiVG/tourism-package-prediction/Xtest.csv"
ytrain_path = "hf://datasets/BalajiVG/tourism-package-prediction/ytrain.csv"
ytest_path  = "hf://datasets/BalajiVG/tourism-package-prediction/ytest.csv"
...
class_weight = float(ytrain.value_counts().iloc[0] / ytrain.value_counts().iloc[1])
...
with mlflow.start_run():
    ...
    # Log every CV combination as a nested run
